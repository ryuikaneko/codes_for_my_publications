...
set ylabel "n^{/Symbol a}" offset 2.0,0.0
set key samplen 1.5
#set key width -3
#set key left top
#set key right top
...
"< awk '\$1>${Uc}{print \$0}' ../dat/fig_5/dat_V4.00" u 1:14:(0) w e ls 1 ti "A", \
"" u 1:13:(0) w e ls 2 ti "B", \
"" u 1:12:(0) w e ls 3 ti "C", \
"" u 1:11:(0) w e ls 4 ti "D", \
"" u 1:10:(0) w e ls 5 ti "E", \
"" u 1:15:(0) w e ls 6 ti "F", \
\
"< awk '\$1<${Uc}{print \$0}' ../dat/fig_5/dat_V4.00" u 1:11:(0) w e ls 1 ti "", \
"" u 1:12:(0) w e ls 2 ti "", \
"" u 1:13:(0) w e ls 3 ti "", \
"" u 1:14:(0) w e ls 4 ti "", \
"" u 1:15:(0) w e ls 5 ti "", \
"" u 1:10:(0) w e ls 6 ti ""
