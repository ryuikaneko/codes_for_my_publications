...
def parse_args():
    parser = argparse.ArgumentParser(description='prepare modpara_aft.def')
    parser.add_argument('-L',metavar='L',dest='L',type=int,default=16,help='set L')
    parser.add_argument('-output',metavar='output_file',dest='output_file',type=str,default='modpara_aft.def',help='set output file name')
...
def print_files(output_file,L):
    ...
    f.write('--------------------\n')
    f.write('CDataFileHead  zvo_aft\n')
    f.write('CParaFileHead  zqp_aft\n')
    f.write('--------------------\n')
    f.write('NVMCCalMode    1\n')
    f.write('--------------------\n')
    f.write('NDataIdxStart  1\n')
    f.write('NDataQtySmp    10\n')
    f.write('--------------------\n')
    f.write('Nsite          %d\n' % L)
    f.write('Ncond          0\n')
#    f.write('2Sz            0\n')
...
#    f.write('NSPStot        0\n')
    ...
    f.write('NVMCWarmUp     10000\n')
    f.write('NVMCInterval   1\n')
    f.write('NVMCSample     10000\n')
