...
def parse_args():
    parser = argparse.ArgumentParser(description='prepare exchange.def')
    ...
    parser.add_argument('-interaction_name',metavar='interaction_name',dest='interaction_name',type=str,default='exchange',help='set interaction_name')
    parser.add_argument('-output',metavar='output_file',dest='output_file',type=str,default='exchange.def',help='set output file name')
